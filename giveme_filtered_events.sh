...
runsubrunlist=/uboone/app/users/imawby/larsoft_sigma/SigmaRecoAnalyser/runsubrunevent.txt

# The name of the sam def which you made the run subrun event list from
originalsamdef=cthorpe_make_hyperon_events_reco2_numi_fhc_run1_pt1_hyperon_reco2_reco2

# choose a name for your sam def, any name as long as it doesnt already exist
newsamdef=imawby_run1_signal_noRecoParticle
